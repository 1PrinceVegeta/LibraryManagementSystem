...
public class LibraryMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("MEMBERSHIP LOANS");
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton3ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 250, -1, -1));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        this.dispose();
        registeredMember rM=new registeredMember();
        rM.setVisible(true);
