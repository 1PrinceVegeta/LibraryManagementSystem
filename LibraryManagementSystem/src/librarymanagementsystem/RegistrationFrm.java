...
public class RegistrationFrm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        registerButton.setForeground(new java.awt.Color(0, 102, 204));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 650, 410));
    ...
    private void registerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerButtonActionPerformed
        ...
        try{ 
        String firstName1, lastName1, addressR1, emailR1, usernameR1, passwordR1 = "";
        firstName1=firstname.getText();
        lastName1=lastname.getText();
        addressR1=address.getText();
        emailR1=email.getText();
        usernameR1=username.getText();
        passwordR1=password.getText();
        
        Registry r=LocateRegistry.getRegistry("127.0.0.1", 1099);
        BookManager bM=(BookManager) r.lookup("LibrarySystemService");
        bM.registerUsers(firstName1, lastName1, addressR1, emailR1, usernameR1, passwordR1);
